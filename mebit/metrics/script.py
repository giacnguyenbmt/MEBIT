...
def evaluate_method_per_sample(gt, subm, evaluationParams=default_evaluation_params()):
    """
    ...
    pointsList, transcriptionsList = gt['boxes'], gt['texts']
    ...
    if True:
        pointsList,confidencesList = subm['boxes'], subm['confidences']
        for n in range(len(pointsList)):
            points = pointsList[n]
